...
ADMINS = (
     ('Camilo Ramirez', 'camilortte@hotmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'calificaUD',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'p*#+otqkkrxtd2d!&fz3vv(qc(hhi(3k1vf-en*b$(@7xte#h%'
...
WSGI_APPLICATION = 'CalificaUD.wsgi.application'
