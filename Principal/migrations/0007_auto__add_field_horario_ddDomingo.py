...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Horario.ddDomingo'
        db.add_column(u'Principal_horario', 'ddDomingo',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Horario.ddDomingo'
        db.delete_column(u'Principal_horario', 'ddDomingo')
    ...
    models = {
        ...
        u'Principal.horario': {
            ...
            'ddDomingo': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
